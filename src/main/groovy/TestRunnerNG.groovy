...
public class TestRunnerNG{
    ...
    public String run(String css, Logger logger, Class[] classes) {
        DbMasterTestHTMLReporter.css = css;
        DbMasterTestHTMLReporter tla = new DbMasterTestHTMLReporter(logger);
        ...
        return tla.toHtmlString();
    }

    private static class DbMasterTestHTMLReporter extends TestListenerAdapter {
        ...
        private static final Comparator<ITestResult> NAME_COMPARATOR = {o1,o2 ->
            String c1 = o1.getMethod().getMethodName();
            String c2 = o2.getMethod().getMethodName();
            return c1.compareTo(c2);
        };
        private static final Comparator<ITestResult> CONFIGURATION_COMPARATOR = { o1, o2 ->
        ...
        public DbMasterTestHTMLReporter(Logger logger) {
            this.logger = logger;
        }

        @Override
        public void onTestSuccess(ITestResult result){
            logger.info("{} {} ms", result.getMethod(),result.getEndMillis()-result.getStartMillis());
            super.onTestSuccess(result);
        }

        @Override
        public void onTestFailure(ITestResult result){
            logger.error("{} {} ms",result.getMethod(),result.getEndMillis()-result.getStartMillis());
            super.onTestFailure(result);
        }
        /*
         @Override
         public void onTestSkipped(ITestResult result){
         logger.info("SKIP {} {} ms",result.getMethod(),result.getEndMillis()-result.getStartMillis());
         super.onTestSkipped(result);
         }*/

        @Override
        public void onTestFailedButWithinSuccessPercentage(ITestResult result){
            logger.warn("{} {} ms",result.getMethod(),result.getEndMillis()-result.getStartMillis());
            ...
            for (ITestResult tr : tests) {
                ...
                if (true){
                    ...
                    if (null != output && output.size() > 0) {
                        ...
                        sb.append("\n<a href=\"#").append(divId).append("\"")
                                .append(" onclick='toggleBox(\"").append(divId).append("\", this, \"Show output\", \"Hide output\");return false;'>")
                                .append("Show output</a>\n")
                                .append("\n<a href=\"#").append(divId).append("\"")
                                .append(" onclick=\"toggleAllBoxes();return false;\">Show all outputs</a>\n")
                        ;
                ...
                if (null != tw) {
                    ...
                    sb.append("<a href='#' onclick='toggleBox(\"")
                            .append(id).append("\", this, \"Click to show all stack frames\", \"Click to hide stack frames\");return false;'>")
                ...
                Collection<ITestResult> percentageTests)
        {
            ...
            sb
                    .append("<h2 align='center'>").append(/*testContext.getName()*/"Test result").append("</h2>")
